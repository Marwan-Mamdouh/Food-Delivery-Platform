...
- **Modern Frontend:** A reactive, SEO-friendly UI powered by **Nuxt 4** and styled with **Tailwind CSS**.
...
| **Frontend** | [Nuxt 4](https://nuxt.com/)                                                  | Vue 3, Nitro Server, SSR/SSG Capabilities               |
...
│   └── web/              # Nuxt 4 Client (Consumer & Restaurant Portal)
├── packages/
